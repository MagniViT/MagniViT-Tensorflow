...
def parse_args():
    ...
    parser.add_argument(
        "--lr", dest="init_lr", help="initial learning rate", default=0.0002, type=float
    )
    parser.add_argument(
        "--decay", dest="weight_decay", help="weight decay", default=1e-5, type=float
    )
    parser.add_argument(
        "--momentum", dest="momentum", help="momentum", default=0.9, type=float
    )
    parser.add_argument(
        "--epoch",
        dest="max_epoch",
    ...
    parser.add_argument(
        "--n_classes", dest="n_classes", help="number of classes", default=2, type=int
    )
    parser.add_argument(
        "--seed_value",
        dest="seed_value",
    ...
    parser.add_argument(
        "--run", dest="run", help="number of experiments to be run", default=5, type=int
    )
    parser.add_argument(
        "--n_folds",
        dest="n_folds",
    ...
    parser.add_argument(
        ...
        default="/run/user/1001/gvfs/smb-share:server=rds.icr.ac.uk,share=data/DBI/DUDBI/DYNCESYS/OlgaF/camelyon_data/camelyon_features/tumor_vs_normal_resnet_features/",
        type=str,
    )
    parser.add_argument(
        "--experiment_name",
